...
CREATE TABLE Usuarios (
    ID SMALLINT IDENTITY NOT NULL CONSTRAINT PK_Usuarios PRIMARY KEY
...
CREATE TABLE Carreras (
    Código SMALLINT IDENTITY NOT NULL CONSTRAINT PK_Carreras PRIMARY KEY 
...
AS BEGIN
	BEGIN TRANSACTION
		...
		SET @Id = @Id + 1
		INSERT INTO Usuarios VALUES (@Id, @Nombre, 0, @email, @Contraseña)
	COMMIT
END
...
AS BEGIN	
	BEGIN TRANSACTION
		...
		EXECUTE ModificarSaldo @IdUsuario,@Importe, 'Deducción por apuesta realizada'
