...
CREATE TABLE PilotoCarreras(
	[Numero Piloto] TINYINT NOT NULL CONSTRAINT FK_PilotoCarrera FOREIGN KEY REFERENCES Pilotos(Numero) ON DELETE CASCADE ON UPDATE CASCADE
	,[Código Carrera] SMALLINT NOT NULL CONSTRAINT FK_PilotoCarrera FOREIGN KEY REFERENCES Carreras(Código) ON DELETE CASCADE ON UPDATE CASCADE
