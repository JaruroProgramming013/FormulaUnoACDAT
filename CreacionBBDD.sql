...
CREATE TABLE PilotoCarreras(
	 [Numero Piloto] TINYINT NOT NULL CONSTRAINT FK_CodigoPiloto FOREIGN KEY REFERENCES Pilotos(Numero) ON DELETE CASCADE ON UPDATE CASCADE
	...
	,PRIMARY KEY ([Numero Piloto], [Codigo Carrera])
