...
CREATE TABLE Usuarios (
    ...
    ,Email VARCHAR(50) NOT NULL CONSTRAINT CK_Email CHECK (Email LIKE '%_@__%.__%') CONSTRAINT UQ_Email UNIQUE
...
CREATE TABLE Pilotos(
	ID SMALLINT IDENTITY (1,1) NOT NULL CONSTRAINT PK_Pilotos PRIMARY KEY
...
CREATE TABLE PilotosCarreras(
	 [ID Piloto] SMALLINT NOT NULL CONSTRAINT FK_CodigoPiloto FOREIGN KEY REFERENCES Pilotos(ID) ON DELETE CASCADE ON UPDATE CASCADE
